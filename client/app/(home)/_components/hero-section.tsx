...
const HeroSection = () => {
  return (
    <div className="flex md:flex-row gap-3 flex-col max-w-screen-2xl sm:justify-between">
      <div className=" w-full flex flex-col gap-4 h-scree bgred-300">
        <h1 className="sm:text-7xl text-5xl  md:text-[4.3rem] leading-[3rem] sm:leading-[5rem] ">
          Unlock Your <br />
        ...
        <p className="text-sm md:text-left text-center text-gray-500">
          Discover Opportunities and Elevate Your Professional Journey
        </p>
        <div className="flex sm:flex-row flex-col items-center gap-4">
          <Input
            className="rounded-full bg-gray-100 border-none focus-visible:ring-slate-300"
        ...
        <div className="flex flex-col mt-10">
          <p className="text-base md:text-left text-center text-gray-500">
      ...
      <div className="w-full h-screen bg-red-300">hello</div>
    </div>
  );
};
